...
export class DataForm {
	...
	incomeTypeOptions = ["", "BELI VALAS", "HASIL TUKAR VALAS", "ISI KAS", "ISI KAS RP", "JASA GIRO", "KELEBIHAN BAYAR", "LAIN - LAIN", "PEMINDAHAN ANTAR KAS", "PENGEMB.UPAH", "PENGEMBALIAN BIAYA INKLARING", "PENGEMBALIAN BIAYA PIBK", "PENGEMBALIAN BIAYA STMB BPJS", "PENGEMBALIAN FREIGHT", "PENGEMBALIAN PEMBELIAN CASH", "PENGEMBALIAN TAMBAHAN UPAH", "PENGEMBL. VB UANG MUKA BIAYA IMPOR", "PENJUALAN EKSPOR", "PENJUALAN LOKAL", "PINDAHAN ANTAR BANK", "PT KANA EX PENGEMB.PINJAMAN", "PT KANA EX PINJ.SEMENTARA", "SETORAN TUNAI", "TERIMA DARI KEI", "TERIMA DARI PEMBAYARAN SANKSI ADMINISTRASI", "TEXTILE EX PENGEMB.PINJAMAN", "TEXTILE EX PENJUALAN LOKAL", "TEXTILE EX PINJ.SEMENTARA", "TEXTILE EX. PINJAMAN SEMENTARA", "TITIPAN TEXTILE", "TUKAR VALAS"];
